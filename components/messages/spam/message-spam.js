...
class Spam extends HTMLElement {
    constructor() {
        super();
    ...
    _setupActionButtons() {
        ...
        const trashBtn = this.shadowRoot.querySelector(".btn-group button[data-target='Trash']");
        const noSpamBtn = this.shadowRoot.querySelector(".btn-group button[data-target='Inbox']");


        trashBtn.addEventListener("click", () => this.moveToTrash(this.getSelectedMessages()));
        noSpamBtn.addEventListener("click", () => this.moveToInbox(this.getSelectedMessages()));
    ...
    moveToTrash(selectedMessages) {
        console.log("MOVE TO TRASH BUTTON");
    }
    ...
    getButtonTemplate() {
        return `
            ...
            <div class="btn-group">
                <button class="btn btn-default btn-ghost" data-target="Inbox">No Spam</button>
...
customElements.define('message-spam', Spam);