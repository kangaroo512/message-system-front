...
class Archive extends HTMLElement {
    ...
    _setupActionButtons() {
        ...
        const moveToTrashBtn = this.shadowRoot.querySelector(".btn-group button[data-target='Trash']");
        const dropdown = this.shadowRoot.querySelector("#myDropdown");


        moveToTrashBtn.addEventListener("click", () => this.moveToTrash(this.getSelectedMessages()));
        ...
        return `
            ...
            <div class="btn-group">
                <select id="myDropdown" name="myDropdown" class="btn btn-default btn-ghost">
                    ...
                    <option value="Trash" class="btn btn-default btn-ghost">Trash</option>
                </select>
...
customElements.define('message-archive', Archive);